...
from pages.pages_helper.layout_grid import grid_option_2, grid_option_1
# Import test data
from src._test_data import df, df_global
# Import functions
from src.app_modals import mapbox_plotly, horizontal_bar_graph, create_subplots
...
def toggle_modal(n1, n2, n3, n4, n5, n6, n7, n8, n9, n10, n11, n12, h1, h2, is_open):
    ...
    if not ctx.triggered:
        ...
        if button_id == 'card-image-1':
            return (not is_open, facade_sun_radiation['title'], facade_sun_radiation[
            'card_introduction'],
                    facade_sun_radiation['description'], modal_default_layout, 
                    facade_sun_radiation['image'])
            ...
            return (not is_open, morning_afternoon_sun_radiation['title'], 
            ...
            return (not is_open, density['title'], density['card_introduction'], 
            density['description'],
                    modal_default_layout, density['image'])
        elif button_id == 'card-image-5':
            return (not is_open, views_availability['title'], views_availability[
            'card_introduction'],
                    views_availability['description'], modal_default_layout, views_availability[
                    'image'])
            ...
            return (not is_open, urban_noise['title'], urban_noise['card_introduction'], 
            urban_noise['description'],
                    modal_default_layout, urban_noise['image'])
        elif button_id == 'card-image-8':
            return (
                not is_open, close_distance_to_green_areas['title'], 
                close_distance_to_green_areas['card_introduction'],
            ...
            return (not is_open, potential_cost_reduction_solar_energy['title'], 
            potential_cost_reduction_solar_energy[
                'card_introduction'], potential_cost_reduction_solar_energy['description'], 
                modal_default_layout,
            ...
            return not is_open, 'Architecture Driven by Data', ('Contemporary architecture is 
            transformed by '
                                                                'data-driven decision-making, 
                                                                harmonizing aesthetics '
                                                                'and practicality to create 
                                                                structures that resonate '
                                                                'with the modern world.'), 
                                                                modal_experience, None, None
        elif button_id == 'helper-button-2':
            return not is_open, 'Data-Driven Decision Making', ('Data-driven decision making is 
            the process of making '
                                                                'decisions based on data analysis 
                                                                and '
                                                                'interpretation.'), 
                                                                modal_article_published, None, None
...
views = {
    "section_Este": "https://speckle.xyz/embed?stream=4000327e5d&commit=0edc6b2b24&c=%5B-48.51712"
                    "%2C21.59411%2C16.39624%2C18.75933%2C21.59411%2C16.39624%2C0%2C1%5D&filter"
                    "=%7B%22sectionBox%22%3A%5B7.64%2C-2.95%2C-18.56%2C62.09%2C50.95%2C37.81%5D"
                    "%7D&transparent=true&autoload=true&hidecontrols=true&hidesidebar=true"
                    "&hideselectioninfo=true",
    "elevation_Este": "https://speckle.xyz/embed?stream=4000327e5d&commit=0edc6b2b24&transparent"
                      "=true&autoload=true&hidecontrols=true&hidesidebar=true&hideselectioninfo"
                      "=true",
    "section_Oeste": "https://speckle.xyz/embed?stream=4000327e5d&commit=0edc6b2b24&c=%5B23.17697"
                     "%2C91.27659%2C15.39427%2C23.17697%2C24.00014%2C15.39427%2C0%2C1%5D&filter"
                     "=%7B%22sectionBox%22%3A%5B-3.22%2C-15.27%2C-18.56%2C51.22%2C38.63%2C37.81"
                     "%5D%7D&transparent=true&autoload=true&hidecontrols=true&hidesidebar=true"
                     "&hideselectioninfo=true",
    "elevation_Oeste": "https://speckle.xyz/embed?stream=4000327e5d&commit=0edc6b2b24&c=%5B-67"
                       ".99179%2C24%2C9.624%2C24%2C24%2C9.624%2C0%2C1%5D&transparent=true"
                       "&autoload=true&hidecontrols=true&hidesidebar=true&hideselectioninfo=true",
    "section_Sur": "https://speckle.xyz/embed?stream=4000327e5d&commit=0edc6b2b24&c=%5B66.71794"
                   "%2C10.48167%2C14.17571%2C32.4325%2C10.48167%2C14.17571%2C0%2C1%5D&filter=%7B"
                   "%22sectionBox%22%3A%5B-17.27%2C-2.95%2C-18.56%2C37.18%2C50.95%2C37.81%5D%7D"
                   "&transparent=true&autoload=true&hidecontrols=true&hidesidebar=true"
                   "&hideselectioninfo=true",
    "elevation_Sur": "https://speckle.xyz/embed?stream=4000327e5d&commit=0edc6b2b24&c=%5B110"
                     ".50025%2C24%2C9.624%2C24%2C24%2C9.624%2C0%2C1%5D&transparent=true&autoload"
                     "=true&hidecontrols=true&hidesidebar=true&hideselectioninfo=true",
    "plan": "https://speckle.xyz/embed?stream=35ba1243e5&commit=22da188d36&c=%5B24%2C23.99993"
            "%2C81.9093%2C24%2C24%2C9.624%2C0%2C1%5D&filter=%7B%22sectionBox%22%3A%5B-3.22%2C-2"
            ".95%2C-38.01%2C51.22%2C50.95%2C18.36%5D%7D&transparent=true&autoload=true"
            "&hidecontrols=true&hidesidebar=true&hideselectioninfo=true"
}
...
def create_map(selectedData, image_url):
    ...
    if selectedData is None:
        top_performers, low_performers, global_performers = horizontal_bar_graph(df, df_global,
                                                                                 colors_str=colors_str)
        subplot_fig = create_subplots(df, colors_str=colors_str)  # Create the subplot

        return (
        mapbox_plotly(city_data=df, df_global=df_global, colors_str=colors_str), top_performers,
        ...
        top_performers, low_performers, global_performers = horizontal_bar_graph(city_data,
                                                                                 df_global,
                                                                                 colors_str=colors_str)
        subplot_fig = create_subplots(city_data, colors_str=colors_str)  # Create the subplot
        # Create the mapbox plot
        return (
            mapbox_plotly(city_data=city_data, df_global=df_global, colors_str=colors_str),
            top_performers,
            low_performers,
