...
dash.register_page(__name__, path="/endpoints")
...
note_alert = dbc.Row(dbc.Col([
    dbc.Alert("This is a note!", color="primary"),
    dbc.Alert("This is an alert!", color="danger"),
    dbc.Alert("This is a warning!", color="warning")
], className='mx-6'))
