...
modal_default_layout = dbc.Row([
    ...
    dbc.Row([
        ...
        dcc.Markdown("""**Figure 1.** Bar chart about the current performance of the assets."""),
        dcc.Markdown(congrats_intro),
    ]),
    html.H3('Valuable Assets on Current Analysis'),
    html.Span('Location of best performing assets:'),
    dbc.Row(
    ...
    dbc.Row([
        html.Hr(style={'borderTop': '1px solid white'}),
        html.Span("Know more about this analysis on your assets, please visit the [GitHub repository]()"),
        html.Hr(style={'borderTop': '1px solid white'}),
        html.Hr(style={'borderTop': '1px solid white'}),
    ]),
