...
from pages.layout_default import layout_footer, layout_header, sidebar
...
layout_modal = html.Div([
    ...
    ], id='modal', size='lg', scrollable=True, is_open=False,
                    ...
                    dbc.CardBody(
                        [
                            html.H5("Experience",
                                    className="card-title"),
                            html.P(
                                "Go-to resource for entering the world of collaborative software development on GitHub, providing essential tools and insights to kickstart your coding projects.",
                                className="card-text"),
                    ...
                    dbc.CardBody(
                        [
                            html.H5("Articles Published",
                                    className="card-title"),
                            html.P(
                                "Repository of your expertise and ideas, featuring a collection of insightful and informative articles you've shared with the world.",
                                className="card-text"),
                    ...
                    dbc.CardBody(
                        [
                            html.H5("Credits and Acknowledgements",
                                    className="card-title"),
                            html.P(
                                "Invaluable contributions of individuals and teams who have been instrumental in shaping your projects, fostering a culture of gratitude and collaboration.",
                                className="card-text"),
...
layout = html.Div([
    # add empty vetical space
    html.Hr(style={'height': '0px', 'margin-top': '1rem', 'color': 'white'}),
